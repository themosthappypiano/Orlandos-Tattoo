          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="border border-white/20 p-8 md:p-12 relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="relative overflow-hidden rounded-lg group">
                  <img 
                    src="/gallery-1.jpg" 
                    alt="Custom tattoo artwork showcase" 
              ...
              <Button asChild className="w-full">
                <Link href="/book">Discuss Your Idea</Link>
              </Button>
            </div>
            ...
            <div className="border border-white/20 p-8 md:p-12 relative overflow-hidden flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="relative overflow-hidden rounded-lg group">
                  <img 
                    src="/piercing-actual-1.jpg" 
                    alt="Professional ear piercing by Grace" 
                    className="w-full h-32 object-cover hover:scale-105 transition-transform duration-300 rounded-lg"
                  />
                </div>
                <div className="relative overflow-hidden rounded-lg group">
                  <img 
                    src="/piercing-actual-2.jpg" 
                    alt="Professional piercing work by Grace" 
                    className="w-full h-32 object-cover hover:scale-105 transition-transform duration-300 rounded-lg"
                  />
                </div>
              </div>
              ...
              <Button asChild variant="outline" className="w-full mt-auto">
                <Link href="/book">Inbox Us About Availability</Link>
              </Button>
            </div>
